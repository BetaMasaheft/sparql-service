...
<xsl:stylesheet xmlns:pleiades="https://pleiades.stoa.org/"
    ...
    xmlns:rdfs="http://www.w3.org/2000/01/rdf-schema#" xmlns:wd="https://www.wikidata.org/"
    xmlns:geo="http://www.w3.org/2003/01/geo/wgs84_pos#"
    xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:oa="http://www.w3.org/ns/oa#"
    xmlns:doap="http://usefulinc.com/ns/doap#" xmlns:rel="http://purl.org/vocab/relationship/"
    ...
    xmlns:funct="http://myfunction" xmlns:svcs="http://rdfs.org/sioc/services#"
    xmlns:gn="http://www.geonames.org/ontology#"
    xmlns:agrelon="http://d-nb.info/standards/elementset/agrelon.owl#"
    xmlns:betmas="https://betamasaheft.eu/ontology/" xmlns:lawd="http://lawd.info/ontology/"
    ...
    xmlns:snap="http://data.snapdrgn.net/ontology/snap#" xmlns:dc="http://purl.org/dc/elements/1.1/"
    exclude-result-prefixes="funct" version="2.0">
    <xsl:output method="xml" indent="yes" encoding="UTF-8" />

    <xsl:function name="funct:parseLocusRef">
        <xsl:param name="FromToTarget" />
        <xsl:analyze-string select="$FromToTarget"
            regex="(\d+)([r|v])?([a-z])?(\d+)?">
    ...
    <xsl:function name="funct:id">
        ...
        <xsl:choose>
            ...
            <xsl:when test="contains($id, 'pleaides:')">
                <xsl:value-of
                    select="concat('https://pleiades.stoa.org/places/', substring-after($id, 'pleiades:'))" />
            </xsl:when>
            <xsl:when test="contains($id, 'sdc:')">
                <xsl:value-of
                    select="concat('https://w3id.org/sdc/ontology#', substring-after($id, 'sdc:'))" />
            </xsl:when>
            <xsl:when test="contains($id, 'wd:')">
                <xsl:value-of
                    select="concat('https://www.wikidata.org/entity/', substring-after($id, 'wd:'))" />
            </xsl:when>
            <xsl:when test="contains($id, 'skos:')">
                <xsl:value-of
                    select="concat('http://www.w3.org/2004/02/skos/core#', substring-after($id, 'skos:'))" />
            </xsl:when>
            <xsl:when test="contains($id, 'saws:')">
                <xsl:value-of
                    select="concat('http://purl.org/saws/ontology#', substring-after($id, 'saws:'))" />
            </xsl:when>
            <xsl:when test="contains($id, 'snap:')">
                <xsl:value-of
                    select="concat('http://data.snapdrgn.net/ontology/snap#', substring-after($id, 'snap:'))" />
            </xsl:when>
            <xsl:when test="contains($id, 'gn:')">
                <xsl:value-of
                    select="concat('http://www.geonames.org/ontology#', substring-after($id, 'gn:'))" />
            </xsl:when>
            <xsl:when test="contains($id, 'dcterms:')">
                <xsl:value-of
                    select="concat('http://purl.org/dc/terms/', substring-after($id, 'dcterms:'))" />
            </xsl:when>
            ...
            <xsl:when test="contains($id, 'lawd:')">
                <xsl:value-of
                    select="concat('http://lawd.info/ontology/', substring-after($id, 'lawd:'))" />
            </xsl:when>
            <xsl:when test="contains($id, 'syriaca:')">
                <xsl:value-of
                    select="concat('http://syriaca.org/documentation/relations.html#', substring-after($id, 'syriaca:'))" />
                <!-- <xsl:text>http://syriaca.org/documentation/relations.html#</xsl:text>
                <xsl:value-of select="$id"/>-->
            </xsl:when>
            <xsl:when test="contains($id, 'agrelon:')">
                <xsl:value-of
                    select="concat('http://d-nb.info/standards/elementset/agrelon.owl#', substring-after($id, 'agrelon:'))" />
            </xsl:when>
            <xsl:when test="contains($id, 'rel:')">
                <xsl:value-of
                    select="concat('http://purl.org/vocab/relationship/', substring-after($id, 'rel:'))" />
            </xsl:when>
            <xsl:otherwise>
                <xsl:variable name="subid">
                    <xsl:choose>
                        <xsl:when test="contains($id, '#')">
                            ...
                            <xsl:variable
                                name="anchor" select="substring-after($id,'#')" />
                            <xsl:variable
                                name="type">
                                ...
                                <xsl:choose>
                                    ...
                                    <xsl:when test="starts-with($anchor, 'p')">
                                        <xsl:choose>
                                            <xsl:when
                                                test="contains($anchor, '_') and contains($anchor, 'coloph')">
        colophon</xsl:when>
                                            <xsl:when
                                                test="contains($anchor, '_') and contains($anchor, 'i')">
        msitem</xsl:when>
        ...
        msitem</xsl:when>
                            ...
                            <xsl:value-of
                                select="concat($mainPart, '/', $type, '/', $anchor)" />
                        </xsl:when>
                        <xsl:otherwise>
                            <xsl:value-of select="$id" />
                        </xsl:otherwise>
                ...
                <xsl:value-of
                    select="concat('https://betamasaheft.eu/', encode-for-uri($subid))" />
            </xsl:otherwise>
        </xsl:choose>
    </xsl:function>

    <xsl:variable name="editors"
        select="doc('https://raw.githubusercontent.com/BetaMasaheft/BetMas/master/db/apps/lists/editors.xml')" />
    <xsl:template match="t:TEI">
        <rdf:RDF>
            ...
            <xsl:variable name="mainurl">
                <xsl:value-of
                    select="concat('https://betamasaheft.eu/', $collection, '/', @xml:id, '/main')" />
            </xsl:variable>
            ...
            <rdf:Description rdf:about="https://betamasaheft.eu/{@xml:id}">
                ...
                <crm:P48_has_preferred_identifier>
                    <!--                    relates an E1 Entity (inherited from superProperty P1) with an E42
                    Identifier-->
                ...
                <xsl:if test="@type = 'mss'">
                    ...
                    <rdf:type
                        rdf:resource="https://w3id.org/sdc/ontology#UniProd" />
                    <rdf:type
                        rdf:resource="https://w3id.org/sdc/ontology#UniCirc" />
                    <sdc:hasCertainty
                        rdf:resource="https://w3id.org/sdc/ontology#Certain" />
                    <!--                    the physDesc can be BOTH at top level and in each msPart, it needs to be
                    called here anyway, then also in each msPart if there is any-->
                    <xsl:apply-templates
                        select="//t:msDesc/t:msIdentifier">
                        <xsl:with-param name="mainID">
                            <xsl:value-of select="$mainID" />
                        </xsl:with-param>
                    </xsl:apply-templates>
                    <xsl:apply-templates
                        select="//t:msDesc/t:physDesc">
                        <xsl:with-param name="mainID">
                            <xsl:value-of select="$mainID" />
                        </xsl:with-param>
                    </xsl:apply-templates>
                    <xsl:choose>
                        ...
                        <!--                        if the manuscript has parts, count them and add a pointer to them, a
                        further call below will call the template in mode="parturis" producing the
                        uris to which this will refer
                        if there are parts 
                        -->
                        <xsl:when test="//t:msDesc/t:msPart or //t:msDesc/t:msFrag">
                            <crm:P57_has_number_of_parts
                                rdf:datatype="http://www.w3.org/2001/XMLSchema#integer">
                                <xsl:value-of
                                    select="count(//t:msDesc/t:msPart) + count(//t:msDesc/t:msFrag)" />
                            </crm:P57_has_number_of_parts>
                            <xsl:apply-templates
                                select="//t:msDesc/t:msPart | //t:msDesc/t:msFrag">
                                <xsl:with-param name="mainID">
                                    <xsl:value-of select="$mainID" />
                                </xsl:with-param>
                            </xsl:apply-templates>
                        ...
                        <xsl:otherwise>
                            <!--                        if there are parts, there should be no msContent inside msDesc, if
                            there are not parts, then contents are listed in msContents directly in
                            msDesc-->
                            <xsl:if test="//t:msDesc/t:msContents/t:msItem">
                                ...
                                <xsl:apply-templates
                                    select="//t:msDesc/t:msContents/t:msItem">
                                    <xsl:with-param name="mainID">
                                        <xsl:value-of select="$mainID" />
                                    </xsl:with-param>
                                </xsl:apply-templates>
                    ...
                    <xsl:apply-templates
                        select="//t:div[@type='edition']/t:div">
                        <xsl:with-param name="mainID">
                            <xsl:value-of select="$mainID" />
                        </xsl:with-param>
                    </xsl:apply-templates>
                ...
                <xsl:if test="@type = 'place' or @type = 'ins'">
                    ...
                    <foaf:primaryTopicOf
                        rdf:resource="{$mainurl}" />
                    <xsl:if test="//t:place/@sameAs">
                        <skos:exactMatch
                            rdf:resource="https://www.wikidata.org/entity/{replace(//t:person/@sameAs, 'wd:', '')}" />
                    </xsl:if>
                    <xsl:if
                        test="//t:place/@type">
                        <xsl:choose>
                            <xsl:when test="matches(//t:place/@type, '\s')">
                                <xsl:for-each
                                    select="tokenize(normalize-space(//t:place/@type), ' ')">
                                    <pleiades:hasFeatureType
                                        rdf:resource="https://betamasaheft.eu/authority-files/{current()}" />
                                </xsl:for-each>
                            </xsl:when>
                            <xsl:otherwise>
                                <pleiades:hasFeatureType
                                    rdf:resource="https://betamasaheft.eu/authority-files/{//t:place/@type}" />
                            </xsl:otherwise>
                        </xsl:choose>
                    </xsl:if>
                    <xsl:apply-templates
                    ...
                    <xsl:apply-templates
                        select="//t:place/t:placeName" mode="pn" />
                </xsl:if>
                <xsl:if test="@type = 'pers'">
                    <xsl:if test="//t:person/@sameAs">
                        <skos:exactMatch
                            rdf:resource="https://www.wikidata.org/entity/{encode-for-uri(replace(//t:person/@sameAs, 'wd:', ''))}" />
                    </xsl:if>
                    <xsl:if
                        test="//t:person/@sex">
                        <foaf:gender>
                    ...
                    <xsl:apply-templates
                        select="@type | @subtype" />
                    <xsl:apply-templates
                        select="//t:person/t:persName" mode="pn" />
                    <xsl:if test="//t:birth">
            ...
            <!--            general -->
            <!--            for each relation in the TEI document, whereever it occurs it will print a
            RDF:Description with one property called by the @name of the relation 
            this does not need to pass on the main id as a parameter because that will be in attributed stated
            in the relation
            -->
            ...
            <!--            for each placeName produces a OA:Annotation a la Pelagios this will all point to
            the main id
                    ...
                    <xsl:with-param name="passage">
                        <xsl:if test="ancestor::t:ab">
                            <xsl:if test="ancestor::t:*[@n][1]/ancestor::t:*[@n][name() != 'lb'][1]">
                                <xsl:value-of
                                    select="string(ancestor::t:*[@n][name() != 'lb'][1]/ancestor::t:*[@n][name() != 'lb'][1]/@n)" />
                                <xsl:text>.</xsl:text>
                            </xsl:if>
                            <xsl:value-of
                                select="string(ancestor::t:*[@n][name() != 'lb'][1]/@n)" />
                        </xsl:if>
                    </xsl:with-param>
            ...
            <xsl:for-each
                select="//t:persName[@ref[. != 'PRS00000']][not(parent::t:person)][not(ancestor::t:place)][not(ancestor::t:respStmt)]">
            ...
            <xsl:if test="@type = 'mss'">
                <!--                only call templates for direct children of msDesc, for the children of msParts
                the template will create those uris-->
                <!--                additions all have a unique id, the uris can be thus created all here-->
                <xsl:apply-templates
                    select="//t:div[@type='edition']/t:div | //t:msDesc/t:msPart | //t:msDesc/t:msFrag | //t:msDesc/t:msContents/t:msItem | //t:item[ancestor::t:additions] | //t:item[ancestor::t:collation] | //t:item[ancestor::t:foliation] | //t:handNote | t:handDesc | //t:layout | //t:decoNote[ancestor::t:bindingDesc] | //t:decoNote[ancestor::t:decoDesc]"
                    mode="parturis">
                    <xsl:with-param name="mainID">
                        <xsl:value-of select="$mainID" />
                    </xsl:with-param>
            ...
            <xsl:if test="@type = 'work'">
                <!--                only call templates for direct children of div[edition]-->
                    <xsl:apply-templates
                    select="//t:div[@type='edition']/t:div" mode="parturis">
                    <xsl:with-param name="mainID">
                        <xsl:value-of select="$mainID" />
                    </xsl:with-param>
                </xsl:apply-templates>
                    <xsl:for-each
                    select="//t:titleStmt/t:title[@xml:id]">
                    <xsl:if test="text() or @*">
    ...
    <xsl:template match="t:physDesc">
        ...
        <xsl:apply-templates
            select="descendant::t:extent" />
        <xsl:apply-templates
            select="descendant::t:objectDesc//t:material[@key]" />
        <xsl:apply-templates
            select="descendant::t:objectDesc//t:objectType[@ref]" />
        <xsl:apply-templates
            select="descendant::t:rs[@type='execution'][@ref]" />
        <xsl:apply-templates
            select="descendant::t:objectDesc[@form]" />
        <xsl:apply-templates
            select="descendant::t:origDate" />
        <!--        hands -->
        ...
        <!--        quires -->
        <xsl:apply-templates
            select="descendant::t:item[ancestor::t:collation]">
            <xsl:with-param name="mainID">
                <xsl:value-of select="$mainID" />
            </xsl:with-param>
        </xsl:apply-templates>
        <!--        UniMarq -->
        <xsl:apply-templates
            select="descendant::t:item[ancestor::t:foliation]">
            <xsl:with-param name="mainID">
                <xsl:value-of select="$mainID" />
            </xsl:with-param>
        </xsl:apply-templates>
        ...
        <!--       decorations -->
        <xsl:apply-templates
            select="descendant::t:decoNote[ancestor::t:decoDesc]">
            <xsl:with-param name="mainID">
                <xsl:value-of select="$mainID" />
            </xsl:with-param>
        </xsl:apply-templates>
        ...
        <!--       binding -->
        <xsl:apply-templates
            select="descendant::t:decoNote[ancestor::t:bindingDesc]">
            <xsl:with-param name="mainID">
                <xsl:value-of select="$mainID" />
            </xsl:with-param>
        </xsl:apply-templates>
        <!--        additions -->
        <xsl:apply-templates
            select="descendant::t:item[ancestor::t:additions]">
            <xsl:with-param name="mainID">
                <xsl:value-of select="$mainID" />
            </xsl:with-param>
        </xsl:apply-templates>
    ...
    <xsl:template
        match="t:msPart | t:msFrag | t:msItem | t:colophon | t:item[ancestor::t:additions] | t:item[ancestor::t:collation] | t:item[ancestor::t:foliation] | t:handNote | t:handDesc | t:layout | t:decoNote[ancestor::t:bindingDesc] | t:decoNote[ancestor::t:decoDesc]  | t:div[ancestor::t:div[@type='edition']]">
        <xsl:param name="mainID" />
        <xsl:variable name="type">
            <xsl:call-template name="URItype">
                <xsl:with-param name="name">
                    <xsl:value-of
                        select="if(current()/parent::t:list/parent::t:additions) then 'ADD' else if (current()/parent::t:list/parent::t:collation) then 'COL' else if (current()/parent::t:list/parent::t:foliation) then 'FOL' else if (current()//parent::t:binding) then 'BIND' else ()" />
                    <xsl:value-of
                        select="name()" />
                </xsl:with-param>
            </xsl:call-template>
        ...
        <xsl:variable
            name="elemname" select="name()" />
        <xsl:variable name="id"
            select="if(@xml:id) then @xml:id else concat(name(), (count(preceding-sibling::t:*[name() = $elemname])+1))" />
        <dcterms:hasPart
            rdf:resource="{concat($mainID, '/', $type, '/', $id)}" />
    </xsl:template>
    ...
    <xsl:template match="t:msPart | t:msFrag" mode="parturis">
        ...
        <rdf:Description>
            <xsl:attribute name="rdf:about">
                <xsl:value-of
                    select="concat('https://betamasaheft.eu/', $mainID, '/', $type, '/', @xml:id)" />
            </xsl:attribute>
            <rdf:type rdf:resource="https://betamasaheft.eu/{$type}" />
            <!--            a msPart or  msFrag is so encoded because recognized as UniProd. Units it contains
            might decide wheather it is a UniProd-MC, UniProd-C, UniProd-C-MC, UniProd-M -->
        ...
        <xsl:apply-templates
            select="t:msPart | t:msFrag" mode="parturis">
            <xsl:with-param name="mainID">
                <xsl:value-of select="$mainID" />
            </xsl:with-param>
        </xsl:apply-templates>
        <xsl:apply-templates
            select="t:msContents/t:msItem" mode="parturis">
            <xsl:with-param name="mainID">
                <xsl:value-of select="$mainID" />
            </xsl:with-param>
        </xsl:apply-templates>
    ...
    <xsl:template match="t:colophon" mode="parturis">
        ...
        <rdf:Description>
            <xsl:attribute name="rdf:about">
                <xsl:value-of
                    select="concat('https://betamasaheft.eu/', $mainID, '/colophon/', @xml:id)" />
            </xsl:attribute>
    ...
    <xsl:template match="t:msItem" mode="parturis">
        ...
        <rdf:Description>
            <xsl:attribute name="rdf:about">
                <xsl:value-of
                    select="concat('https://betamasaheft.eu/', $mainID, '/msitem/', @xml:id)" />
            </xsl:attribute>
        ...
        <xsl:apply-templates
            select="t:msItem | t:colophon" mode="parturis">
            <xsl:with-param name="mainID">
                <xsl:value-of select="$mainID" />
            </xsl:with-param>
        </xsl:apply-templates>
    ...
    <xsl:template match="t:item[ancestor::t:additions]" mode="parturis">
        ...
        <rdf:Description>
            <xsl:attribute name="rdf:about">
                <xsl:value-of
                    select="concat('https://betamasaheft.eu/', $mainID, '/addition/', @xml:id)" />
            </xsl:attribute>
    ...
    <xsl:template
        match="t:div[ancestor::t:div[@type='edition']] | t:item[ancestor::t:collation] | t:item[ancestor::t:foliation] | t:handNote | t:handDesc | t:layout | t:decoNote[ancestor::t:bindingDesc] | t:decoNote[ancestor::t:decoDesc]"
        mode="parturis">
        <xsl:param name="mainID" />
        <xsl:variable name="type">
            <xsl:call-template name="URItype">
                <xsl:with-param name="name">
                    <xsl:value-of
                        select="if(current()/parent::t:list/parent::t:additions) then 'ADD' else if (current()/parent::t:list/parent::t:collation) then 'COL' else if (current()/parent::t:list/parent::t:foliation) then 'FOL' else if (current()//ancestor::t:binding) then 'BIND' else ()" />
                    <xsl:value-of
                        select="name()" />
                </xsl:with-param>
            </xsl:call-template>
        ...
        <rdf:Description>
            ...
            <xsl:attribute name="rdf:about">
                <xsl:value-of
                    select="concat('https://betamasaheft.eu/', $mainID, '/', $type, '/', $id)" />
            </xsl:attribute>
            ...
            <xsl:if test="t:ab[@type='ruling']">
                <!--                for a different ruling there should be a different layout, so in case the
                layout contains ruling information in a ab[@type="ruling"], it is **also** a UniRégl -->
                <rdf:type
                    rdf:resource="https://w3id.org/sdc/ontology#UniRegl" />
            </xsl:if>
            <xsl:if test="$type = 'layout'">
                <!--                a layout note will always be also a UniMeP. The encoder will have for visible
                distinctions have encoded different layout elements-->
                <rdf:type
                    rdf:resource="https://w3id.org/sdc/ontology#UniMeP" />
                
                <xsl:apply-templates
                    select="descendant::t:objectDesc//t:rs[@type='execution']" />
            </xsl:if>
            <xsl:if test="$type = 'hand'">
                <!--                a handNote will always be also a UniMain. The encoder will have for visible
                distinctions have encoded different handNote elements
                Here although also for a different UniEcri there would be in the TEI a handNote... which
                practically kills the UniEcri
                -->
                <rdf:type
                    rdf:resource="https://w3id.org/sdc/ontology#UniMain" />
            </xsl:if>
               ...
               <xsl:for-each select="tokenize(.,' ')">
                    <xsl:choose>
                        <xsl:when test="starts-with(.,'#')">
                            <!--                           <xsl:message>using corresp template for <xsl:value-of
                            select="."/></xsl:message>-->
                           ...
                           <xsl:variable
                                ...
                                select="$node/ancestor::t:TEI//t:*[@xml:id = $corr]" />
                           <xsl:variable
                                name="type">
                                <xsl:call-template name="URItype">
                                    <xsl:with-param name="name">
                                        <xsl:value-of
                                            select="if($matchingElement/parent::t:list/parent::t:additions) then 'ADD' else if ($matchingElement/parent::t:list/parent::t:collation) then 'COL' else if ($matchingElement/parent::t:list/parent::t:foliation) then 'FOL' else if ($matchingElement//ancestor::t:binding) then 'BIND' else ()" />
                                        <xsl:value-of
                                            select="$matchingElement/name()" />
                                    </xsl:with-param>
                                </xsl:call-template>
                            </xsl:variable>
                            <!--                           <xsl:message><xsl:value-of select="$type"/></xsl:message>-->
                           <dc:relation
                                rdf:resource="{concat('https://betamasaheft.eu/', $mainID, '/', $type, '/', $corr)}" />
                        </xsl:when>
                        <xsl:otherwise>
                            <!--                it should point to another entity-->
                           <dc:relation
                                rdf:resource="{concat('https://betamasaheft.eu/', .)}" />
                        </xsl:otherwise>
                    </xsl:choose>
                </xsl:for-each>
            </xsl:when>
            <xsl:otherwise>
                <xsl:choose>
                    <xsl:when test="starts-with(.,'#')">
                        ...
                        <xsl:variable name="corr"
                            select="substring-after(., '#')" />
                        <xsl:variable name="matchingElement"
                            select="current()/ancestor::t:TEI//t:*[@xml:id = $corr]" />
                        <xsl:variable
                            name="type">
                            <xsl:call-template name="URItype">
                                <xsl:with-param name="name">
                                    <xsl:value-of
                                        select="if($matchingElement//ancestor::t:additions) then 'ADD' else if ($matchingElement//ancestor::t:collation) then 'COL' else if ($matchingElement//ancestor::t:foliation) then 'FOL' else if ($matchingElement//ancestor::t:binding) then 'BIND' else ()" />
                                    <xsl:value-of
                                        select="$matchingElement/name()" />
                                </xsl:with-param>
                            </xsl:call-template>
    ...
    <xsl:template match="t:locus">
        <!--        to preserve EACH distinct locus, because there might be texts where an encoding is made
        as 
            ...
            <betmas:locusTo>
                    ...
                    <xsl:if test="@target">
                        <xsl:choose>
                            ...
                            <xsl:variable
                                        name="parseT" select="funct:parseLocusRef($t)" />
                             <betmas:locusTarget>
    ...
    <xsl:template name="newResource">
        ...
        <xsl:variable name="candidatenewsubid"
            select="substring-after($thisid, '#')" />
        <xsl:if
            test="starts-with($candidatenewsubid, 'Uni') or starts-with($candidatenewsubid, 'tr')">
            <xsl:variable name="SdC">
                <xsl:choose>
                    ...
                    <!--                                the collation lists each quire, but the UniCah is made of several,
                    so this can only be considered as Elements-->
            ...
            <rdf:type
                rdf:resource="{concat('https://w3id.org/sdc/ontology#', $SdC)}" />
        </xsl:if>
        <xsl:if
            test="starts-with($candidatenewsubid, 'http')">
            <rdf:type rdf:resource="{$candidatenewsubid}" />
        </xsl:if>
        <xsl:if
            test="starts-with($candidatenewsubid, 'tr')">
            <rdf:type rdf:resource="http://www.cidoc-crm.org/cidoc-crm/E11_Modification" />
        </xsl:if>
        <xsl:if
            test="starts-with($candidatenewsubid, 'UniCirc') or starts-with($candidatenewsubid, 'UniProd')">
            <rdf:type rdf:resource="http://www.cidoc-crm.org/cidoc-crm/E18_Physical_Thing" />
        </xsl:if>
    </xsl:template>

    <xsl:template match="t:relation[@active][@passive]">
        <xsl:variable name="active-attr" select="@active" />
        <xsl:variable name="passive-attr" select="@passive" />
        <xsl:variable name="about">
            <xsl:value-of select="funct:id($active-attr)" />
        </xsl:variable>
        <xsl:variable name="name" select="@name" />
        <xsl:choose>
            <xsl:when test="contains($passive-attr, ' ')">
                <rdf:Description rdf:about="{$about}">
                    <xsl:if test="contains($active-attr, '#')">
                        <xsl:call-template name="newResource">
                            <xsl:with-param name="thisid">
                                <xsl:value-of select="$active-attr" />
                            </xsl:with-param>
                        </xsl:call-template>
                    </xsl:if>
                    <xsl:for-each select="tokenize(normalize-space($passive-attr), ' ')">
                        <xsl:variable name="resource">
                            <xsl:value-of select="funct:id(current())" />
                        </xsl:variable> 
                       <xsl:choose>
                            <xsl:when test="starts-with($name, 'snap:')">
                                <xsl:variable name="bond-from-resource">
                                    <xsl:choose>
                                        <xsl:when test="starts-with(current(), 'https://betamasaheft.eu/')">
                                            <xsl:value-of select="current()" />
                                        </xsl:when>
                                        <xsl:otherwise>
                                            <xsl:value-of select="concat('https://betamasaheft.eu/bond/', substring-after($name, 'snap:'), '-', current())" />
                                        </xsl:otherwise>
                                    </xsl:choose>
                                </xsl:variable>
                                <snap:hasBond rdf:resource="{$bond-from-resource}" />
                            </xsl:when>
                            <!--                     
                           ...
                           -->
                            <xsl:when test="contains($name, 'inLawOf')">
                                <snap:hasBond rdf:resource="https://betamasaheft.eu/bond/{substring-after($name, 'betmas:')}-{current()}" />
                            </xsl:when>
                            <xsl:otherwise>
                ...
                <xsl:for-each select="tokenize(normalize-space($passive-attr), ' ')">
                    <rdf:Description rdf:about="{current()}">
                        <rdf:type rdf:resource="{replace($name, 'snap:', 'http://data.snapdrgn.net/ontology/snap#')}" />
                        <snap:bond-with rdf:resource="{current()}" />
                    </rdf:Description>
                </xsl:for-each>
            </xsl:when>
            <xsl:otherwise>
                <xsl:variable name="resource">
                    <xsl:value-of select="funct:id($passive-attr)" />
                </xsl:variable>
                <rdf:Description
                    rdf:about="{$about}">
                    <xsl:if test="contains($active-attr, '#')">
                    ...
                    <xsl:choose>
                        <xsl:when test="starts-with($name, 'snap:')">
                            <snap:hasBond
                                rdf:resource="https://betamasaheft.eu/bond/{substring-after($name, 'snap:')}-{$passive-attr}" />
                        </xsl:when>
                        <!--                     
                               in laws are not in the snap ontology, where there is however a Class 'InLawFamilyRelationship'
                           When this property from BM is present, it need to be transformed in a series of snap bonds.
                        ...
                        <xsl:when test="contains($name, 'inLawOf')">
                            <snap:hasBond
                                rdf:resource="https://betamasaheft.eu/bond/{substring-after($name, 'betmas:')}-{.}" />
                        </xsl:when>
                        <xsl:otherwise>
                            <xsl:element name="{$name}">
                                <xsl:attribute name="rdf:resource">
        ...
        <xsl:if
            ...
            <xsl:variable name="viewer">
                <xsl:choose>
                    ...
                    <xsl:otherwise>
                        <xsl:value-of
                            select="concat('https://betamasaheft.eu/manuscript/',$mainID , '/viewer')" />
                    </xsl:otherwise>
                </xsl:choose>
            </xsl:variable>
            <xsl:variable
                ...
                <xsl:choose>
                    ...
                    <xsl:otherwise>
                        <xsl:value-of
                            select="concat('https://betamasaheft.eu/api/iiif/',$mainID , '/manifest')" />
                    </xsl:otherwise>
                </xsl:choose>
            </xsl:variable>
            <foaf:depiction>
    ...
    <xsl:template match="t:material">
        <xsl:if test="@ref">
            <crm:P46_is_composed_of rdf:resource="{@ref}" />
        </xsl:if>
        <crm:P46_is_composed_of
            rdf:resource="{concat('https://betamasaheft.eu/vocabularies/material.html#',@key)}" />
    </xsl:template>
    ...
    <xsl:template match="t:ref[@type]">
        <xsl:choose>
            <xsl:when test="matches(@corresp, '\s')">
                <xsl:for-each
                    select="tokenize(normalize-space(@corresp), ' ')">
                    <xsl:variable name="resource-iri">
                        <xsl:choose>
                            <xsl:when test="starts-with(current(), 'https://betamasaheft.eu/')">
                                <xsl:value-of select="current()" />
                            </xsl:when>
                            <xsl:otherwise>
                                <xsl:value-of select="concat('https://betamasaheft.eu/', current())" />
                            </xsl:otherwise>
                        </xsl:choose>
                    </xsl:variable>
                    <dc:relation
                        rdf:resource="{$resource-iri}" />
                </xsl:for-each>
            </xsl:when>
            <xsl:otherwise>
                <xsl:variable name="resource-iri">
                    <xsl:choose>
                        <xsl:when test="starts-with(@corresp, 'https://betamasaheft.eu/')">
                            <xsl:value-of select="@corresp" />
                        </xsl:when>
                        <xsl:otherwise>
                            <xsl:value-of select="concat('https://betamasaheft.eu/', @corresp)" />
                        </xsl:otherwise>
                    </xsl:choose>
                </xsl:variable>                
                <dc:relation
                    ...
                    <crm:E52_Time-span>
                        <xsl:choose>
                            <xsl:when test="name() = 'birth'">
                                <rdf:type
                                    rdf:resource="http://www.cidoc-crm.org/cidoc-crm/E67_Birth" />
                            </xsl:when>
                            <xsl:when test="name() = 'death'">
                                <rdf:type
                                    rdf:resource="http://www.cidoc-crm.org/cidoc-crm/E69_Death" />
                            </xsl:when>
                        </xsl:choose>
    ...
    <xsl:template match="t:title">
        <xsl:param name="mainID" />
        <xsl:if
            test="(text() or @*) and not(.[@xml:lang][not(@ref)][not(text())])">
            <dc:title>
    ...
    <xsl:template match="t:repository">
        <crm:P55_has_current_location rdf:resource="{@ref}" />
    </xsl:template>
    ...
    <xsl:template match="t:witness">
        <xsl:choose>
            <xsl:when test="matches(@corresp, '\s')">
                <xsl:for-each
                    select="tokenize(normalize-space(@corresp), ' ')">
                    <dc:source rdf:resource="{funct:id(current())}" />
                </xsl:for-each>
            </xsl:when>
            <xsl:otherwise>
                <dc:source rdf:resource="{funct:id(@corresp)}" />
            </xsl:otherwise>
        </xsl:choose>
    </xsl:template>
    ...
    <xsl:template name="places">
        ...
        <xsl:variable name="resource-for-hasBody">
            <xsl:choose>
                <xsl:when test="starts-with(@ref, 'pleiades:')">
                    <xsl:value-of
                        select="concat('https://pleiades.stoa.org/places/', substring-after(@ref, 'pleiades:'))" />
                </xsl:when>
                <xsl:when test="starts-with(@ref, 'wd:Q')"><xsl:value-of
                        select="concat('https://www.wikidata.org/entity/', replace(@ref, 'wd:', ''))" />
                </xsl:when>
                <xsl:otherwise>
        ...
        <oa:Annotation
            rdf:about="https://betamasaheft.eu/{$mainID}/place/annotation/{$n}">
            <oa:hasTarget rdf:resource="https://betamasaheft.eu/{$mainID}" />
            <oa:hasBody rdf:resource="{$resource-for-hasBody}" />
            ...
            <xsl:if test="($passage != ' ' and $citation != '') and matches($passage,'[\w\d]+')">
                <lawd:hasAttestation
                    rdf:resource="{concat('https://betamasaheft.eu/api/dts/document?id=https://betamasaheft.eu/',$mainID,':',$passage)}" />
            <lawd:hasCitation>
    ...
    <xsl:template name="persons">
        ...
        <xsl:variable name="resource-for-hasBody">
            <xsl:choose>
                ...
                <xsl:when test="starts-with(@ref, '#')">
                    <xsl:variable name="editor-fullname">
                ...
                <xsl:value-of
                        select="concat('https://betamasaheft.eu/editors/', encode-for-uri($editor-fullname))" />
                </xsl:when>
                <xsl:otherwise>
                    <xsl:value-of select="concat('https://betamasaheft.eu/', @ref)" />
                </xsl:otherwise>
        ...
        <oa:Annotation
            rdf:about="https://betamasaheft.eu/{$mainID}/person/annotation/{$n}">
            <xsl:if test="@type">
                <rdf:type rdf:resource="https://betamasaheft.eu/{@type}" />
            </xsl:if>
            <xsl:if test="@role">
                <rdf:type
                    rdf:resource="https://betamasaheft.eu/ontology/{concat(upper-case(substring(@role,1,1)),substring(@role,2))}" />
            </xsl:if>
            <oa:hasTarget rdf:resource="https://betamasaheft.eu/{$mainID}" />
            <oa:hasBody rdf:resource="{$resource-for-hasBody}" />
            <oa:annotatedAt rdf:datatype="http://www.w3.org/2001/XMLSchema#date">
    ...
    <xsl:template match="t:persName">
        <xsl:variable name="resource-iri">
            <xsl:choose>
                <xsl:when test="starts-with(@ref, 'https://betamasaheft.eu/')">
    ...
    <xsl:template match="t:title" mode="rel">
        <dc:relation rdf:resource="{concat('https://betamasaheft.eu/', @ref)}" />
    </xsl:template>
